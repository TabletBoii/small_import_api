...
alias_field_dict = {
    ...
    "partner$category$color": "pc.color",
...
title_alias_dict = {
    "ID заявки": "claim$inc",
    "Статус заявки": "claim$status",
    "Статус оплаты заявки": "claim$paidstatus",
    "ID партнёра": "partner$inc",
    "Название партнёра": "partner$name",
    "Дата добавления партнёра": "partner$adate",
    "Веб-сайт партнёра": "partner$internet",
    "Телефон партнёра": "partner$phone",
    "Цвет категории партнёра": "partner$category$color",
    "Страна партнёра": "partner$state",
    "ID города партнёра": "partner$town$inc",
    "Город партнёра": "partner$town$name",
    "Название тура": "tour$name",
    "Дата бронирования": "claim$rdate",
    "Дата создания заявки": "claim$cdate",
    "Дата и время создания заявки": "claim$cdatetime",
    "Дата начала тура": "claim$datebeg",
    "Дата окончания тура": "claim$dateend",
    "Количество ночей": "claim$nights",
    "Дата подтверждения": "claim$confirmeddate",
    "Нетто-сумма": "claim$net",
    "Агентское нетто (?)": "claim$anet",
    "Оплачено (нетто)": "claim$paidnet",
    "Долг (нетто)": "claim$debtnet",
    "Стоимость": "claim$cost",
    "Оплачено (стоимость)": "claim$paidcost",
    "Долг (стоимость)": "claim$debtcost",
    ...
    "Итоговая комиссия": "claim$total_commiss",
    "Налог": "claim$tax",
    "Сумма к оплате": "claim$amount_to_pay",
    "Kickback": "claim$kickback",
    ...
    "Валюта": "claim$currency$alias",
    "Заметка": "claim$note",
    "Комментарий": "claim$comment",
    "Внутренний комментарий": "claim$privatecomment",
